...
import { MetricsData } from '../../services/temp.service';
import { TempService} from '../../services/temp.service';

@Component({
  selector: 'app-widget-area-temp',
  templateUrl: './widget-area-temp.component.html',
  styleUrls: ['./widget-area-temp.component.scss']
})
export class WidgetAreaTempComponent implements OnInit {

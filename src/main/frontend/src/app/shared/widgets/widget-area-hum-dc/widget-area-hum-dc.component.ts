...
import { Hum_dcService, MetricsData } from '../../services/hum_dc.service';

@Component({
  selector: 'app-widget-area-hum-dc',
  templateUrl: './widget-area-hum-dc.component.html',
  styleUrls: ['./widget-area-hum-dc.component.scss']
})
export class WidgetAreaHumDcComponent implements OnInit {

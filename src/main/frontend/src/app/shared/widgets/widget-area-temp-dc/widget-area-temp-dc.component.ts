...
import { MetricsData } from '../../services/temp_dc.service';
import { Temp_dcService} from '../../services/temp_dc.service';

@Component({
  selector: 'app-widget-area-temp-dc',
  templateUrl: './widget-area-temp-dc.component.html',
  styleUrls: ['./widget-area-temp-dc.component.scss']
})
export class WidgetAreaTempDcComponent implements OnInit {
  ...
  constructor(private hum: Temp_dcService) {

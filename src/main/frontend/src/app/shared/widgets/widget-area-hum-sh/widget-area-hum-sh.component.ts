...
import { HumShService, MetricsData } from '../../services/hum-sh.service';

@Component({
  selector: 'app-widget-area-hum-sh',
  templateUrl: './widget-area-hum-sh.component.html',
  styleUrls: ['./widget-area-hum-sh.component.scss']
})
export class WidgetAreaHumShComponent implements OnInit {
